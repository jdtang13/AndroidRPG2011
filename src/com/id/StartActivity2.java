...
public class StartActivity2 extends Activity{
	...
	public void onCreate(Bundle savedInstanceState){
        ...
        //statusBars = new StatusBarsView(firstDrawView.getPlayer(),this);
...
//	     updateUI();
    ...
    public void newGame()
    {
     ...
     Toast.makeText(StartActivity2.this, "New Game", Toast.LENGTH_SHORT).show();
    }

    
    public void easyGame()
    {
     Toast.makeText(StartActivity2.this, "Easy Mode", Toast.LENGTH_SHORT).show();
     sleepTime=2000;
    }

    public void hardGame()
    {
     Toast.makeText(StartActivity2.this, "Hard Mode", Toast.LENGTH_SHORT).show();
     sleepTime=600;
    }
    
    public void beastGame()
    {
     Toast.makeText(StartActivity2.this, "Beast Mode", Toast.LENGTH_SHORT).show();
     sleepTime=200;
    }
